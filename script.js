...
window.addEventListener("load",()=>{
    ...
    document.querySelectorAll(
        ...
        ".card h1,.card h2,.card h3,.card p,.info,.notes,.inviteText,.hosts,.dua"
    ...
    setInterval(()=>{
        ...
        card.animate([

            {
                ...
                boxShadow:"0 35px 80px rgba(0,0,0,.12)"

            },

            {

                boxShadow:"0 45px 110px rgba(212,175,55,.18)"
